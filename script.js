...
if (!prefersReducedMotion) {
    ...
    document.querySelectorAll('.service-card, .skill-item, .stat-item, .contact-item')
...
contactForm.addEventListener('submit', (e) => {
    ...
    if (formStatus) formStatus.textContent = 'Enviando tu mensaje...';
...
if (floatingCard && !prefersReducedMotion) {
    let mouseX = 0;
    let mouseY = 0;
    let cardX = 0;
    let cardY = 0;
